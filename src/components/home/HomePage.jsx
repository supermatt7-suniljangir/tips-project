...
import { Container, Typography, Grid, AppBar, Toolbar, Button } from '@mui/material';
...
function HomePage() {
    ...
    return (
        <div style={{ background: '#f0f0f0' }}>
            ...
            <Container maxWidth="lg" style={{ marginTop: '30px', position: 'relative', zIndex: '1' }}>
                <Grid container spacing={4}>
                    <Grid item xs={12} md={6}>
                        <Box>
                            ...
                            <Typography variant="body1" style={{ marginTop: '20px', color: 'white' }}>
                                Join the thousands of service professionals who trust {companyName} to receive tips effortlessly and securely. Streamline your earnings, offer a modern tipping experience, and increase your income—whether you're working directly with clients or providing exceptional service
                            </Typography>
                            <Box mt={3}>
                                <ContactSalesButton>
                                    Contact sales
...
const Banner = () => {
    return (
        <Box sx={{ overflow: 'hidden', width: '100vw', backgroundColor: '#f0f0f0', padding: '20px' }}>
            <Box
                sx={{
                    display: 'flex',
